...
<div id="wrapper">
  ...
  <!--li class="text-center">
    ...
    <li>
      <a class="active-menu" href="viewdb.php">View Database</a>
    </li>
    ...
    <div id="page-inner">
        <div class="row">
            <div class="col-md-12">
                 ...
                 <h3>Tables</h3>
                 <?php
                 $tb = $conn ->query('SHOW TABLES');
                 foreach ($tb as $key => $var)
                 {
                   echo '<a href='.$_SERVER['PHP_SELF'].'?q='.$var[0].'>'.$var[0].'</a><br/>';
                 }

                 if($_GET['q'])
                 {
                   echo '<h4>'.$_GET['q'].'</h4>';
                   $res = $conn ->view($_GET['q']);
                   echo '
                   <table>';
