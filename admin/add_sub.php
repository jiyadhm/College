<?php
  ...
  {
    $var = array($_POST['name'],$_POST['subcode'],$_POST['dept'],$_POST['subcode'],$_POST['sem'],$_POST['marks']);
    $res = $conn -> add_subject($var);
    if($res)
    echo '
  ...
  <!--li class="text-center">
    ...
    <li>
      ...
      <ul class="nav nav-second-level">
        ...
        <li>
            <a class="active-menu" href="add_sub.php">Subject</a>
        </li>
        <li>
